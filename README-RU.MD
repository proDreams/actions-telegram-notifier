...
- Поддерживает события `Push`, `Pull Request`, `Pull Request Review` и `Workflow Dispatch`. (Нужно больше? Откройте
  Issue или отправьте Pull Request!)
...
| `api_url`       | Нет          | Пользовательский [Bot API URL](https://core.telegram.org/bots/api#using-a-local-bot-api-server). Используйте GitHub Secrets для безопасного хранения. |
